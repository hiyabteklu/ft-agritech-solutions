  ...
  return (
    <section id="solutions" className="px-4 py-12 sm:px-6 sm:py-16">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Mobile-friendly search (navbar search is desktop-only) */}
        ...
        {/* Desktop search wired to same state via custom event from Navbar later;
            for now a compact bar under the title on md+ as well for reliability */}
